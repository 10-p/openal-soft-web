...
{
#if HAVE_SSE_INTRINSICS && !defined(__powerpc64__) && !defined(__EMSCRIPTEN__)
...
#elif HAVE_SSE && !defined(__powerpc64__) && !defined(__EMSCRIPTEN__)
...
{
#if (HAVE_SSE_INTRINSICS || HAVE_SSE) && !defined(__powerpc64__) && !defined(__EMSCRIPTEN__)
    _mm_setcsr(state);
#endif
}
